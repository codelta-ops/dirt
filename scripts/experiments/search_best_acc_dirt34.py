...
EXPERIMENTS: List[Dict] = [
    {
        ...
        "purpose": "Current control setting on DIRT_3/4.",
        "args": {
    ...
    {
        "name": "acc_tc0_range08_20_s2lr0006",
    ...
    {
        "name": "acc_tc0_range08_19",
        "purpose": "Slightly tighten the step-weight upper bound.",
        "args": {
            "loss_weight_mode": "learnable",
            "step_weight_hidden_dim": 32,
            "step_weight_dropout": 0.10,
    ...
    {
        "name": "acc_tc0_range08_20_drop005",
        "purpose": "Reduce step-weight dropout for a stronger learnable weighting signal.",
        "args": {
            "loss_weight_mode": "learnable",
            "step_weight_hidden_dim": 32,
            "step_weight_dropout": 0.05,
            "step_weight_use_teacher_confidence": 0,
            "step_weight_use_position_feature": 1,
            "step_weight_min": 0.8,
            "step_weight_max": 2.0,
